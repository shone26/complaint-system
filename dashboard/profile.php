    ...
    <div class="col-md-8 mx-auto">
      <div class="card card-profile">
        <form method="post" class="md-form" id="userProfile-form" enctype="multipart/form-data">
          <div class="card-header card-header-primary " style="    background: linear-gradient(60deg, #000078, #913f9e);">
            <div class="card-avatar">
              ...
              ?>
              <img class="card-img" src="../assets/img/faces/pngwing.com.png" style="background-color: #fff;"/>
