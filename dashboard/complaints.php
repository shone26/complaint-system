...
<div class="container-fluid">
  ...
  ?>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary" style="background: linear-gradient(60deg, #000078, #0000);">
            <div class="row">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table" id="complaints-table">
                ...
                <tbody>
                  <?php
                  $sql = "SELECT complaints.id,complaints.subject,complaints.description,complaints.created_at,complaints.status,complaints.ref_code,complaints.station_name,complaints.address,complaints.phone_number,complaints.gender FROM `complaints` JOIN `users` ON complaints.dept_id=users.dept_id WHERE users.id='" . $_SESSION['userId'] . "'";
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      echo "<td>" . $id . "</td><td>" . $row['ref_code'] . "</td><td>" . $row['subject'] . "</td><td>" . $row['description'] . "</td><td>" . $row['created_at'] . "</td><td>" . $row['station_name'] . "</td><td>" . $row['address'] . "</td><td>" . $row['phone_number'] . "</td><td>" . $row['gender'] . "</td><td class=\"text-primary font-weight-bold\">" . $row['status'] . "</td>";
            ...
            <div class="row">
              ...
              ?>
                <div class="col-12 col-xl-3 col-lg-3">
                  <button class="card-title btn btn-success pl-0 mt-1" data-toggle="modal" data-target="#createComplaintModal" style="background-color:#000078;"><i class="material-icons pl-3 pr-2">add</i>New Complaint</button>
                </div>
              <?php
              }
              ?>
...
<div class="modal fade" id="createComplaintModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content card">
      ...
      <form id="createComplaint-form" method="POST" class="card-body" name="createComplaint-form" enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label for="refCode" class="bmd-label-floating">Complaint Reference Code</label>
                <input type="text" class="form-control" name="complaintRefCode" required>
              </div>
            </div>
          </div>-->
